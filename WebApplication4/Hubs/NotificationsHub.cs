...
{
    private static readonly ConcurrentDictionary<string, NotificationUser> Users = new ConcurrentDictionary<string, NotificationUser>(StringComparer.InvariantCultureIgnoreCase);
    ...
    public override Task OnConnected()
    {
        ...
        var user = Users.GetOrAdd(profileId, _ => new NotificationUser
        {
            ProfileId = profileId,
    ...
    /// </returns>
    private NotificationUser GetUser(string profileId)
    {
        NotificationUser user;
        Users.TryGetValue(profileId, out user);
        return user;
    ...
    public string SendNotifications()
    {
        ...
        {
            string query = "SELECT  Id,Value FROM [dbo].[Likes]";
            connection.Open();
        ...
        //return context.Clients.All.ReceiveNotification(totalNewMessages, totalNewCircles, totalNewJobs, totalNewNotification);
        return "TEXT";
    }
